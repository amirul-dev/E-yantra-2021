...
function dy = RW_pendulum_dynamics(y, m1, m2, l1, wr, g, u)
  ##u=2*u
  I1= m1 * l1^2 / 3; #moment of inertia of bar about pivot point
  I2= m2 * wr^2 * 0.5; #moment of inertial of rotor about its axis
  I2o = m2*l1^2;  #moment of inertia of wheel about O
  y1 = -1*y(1);
  dy(1,1) = y(2);
  dy(2,1) = (-u + (g * l1 * (m1/2 + m2 )* sin(y1))) /(I1 + I2o) ;
  dy(3,1) = y(4);
  dy(4,1) = u/I2 - dy(2,1);
endfunction
...
function [t,y] = lqr_RW_pendulum(m1, m2, l1, wr, g, y_setpoint, y0)
  [A, B] = RW_pendulum_AB_matrix(m1 , m2, l1, wr, g);
<<<<<<< HEAD:Basil/Task_1/Task_1_2/Task1_2_Submission/RW_Pendulum.m
...
=======
  ...
  R = [20];
  K = lqr(A,B,Q,R)
>>>>>>> 3e3c30a317d67501438e2ebe3458344ccc699e81:Basil/Task_1/Task_1_2/RW_Pendulum.m
